...
function updateSensorFootprint() {
	...
	var hpr = new Cesium.HeadingPitchRoll(aircraft.yaw+Math.PI/2.0, -aircraft.pitch, -aircraft.roll+Cesium.Math.toRadians(-180));
    var camQuat = Cesium.Transforms.headingPitchRollQuaternion(camPos, hpr);
